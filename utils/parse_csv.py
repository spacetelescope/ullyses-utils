...
target_csvs = {"lmc":  ["LMC_sample_for_website_clean_newcoord_all_columns_order.csv"],
               ...
               "tts" : ["Cha I_sample_for_website.csv", "CrA_sample_for_website.csv", "Lupus_sample_for_website.csv", "Ori OB1_sample_for_website.csv", "Sigma Ori_sample_for_website.csv", "eps Cha_sample_for_website.csv", "eta Cha_sample_for_website.csv", "Taurus_sample_for_website.csv"],
               "all": []}
